...
**โครงสร้างการตอบกลับ (JSON เท่านั้น):**
{
  ...
  "reading": "เนื้อหาคำทำนายหลัก (Main Reading) **ประโยคแรกต้องฟันธงคำตอบ** จากนั้นเล่าเรื่องราวจากพลังงานของไพ่โดย **ห้ามเอ่ยชื่อไพ่** ใช้ภาษาที่ทันสมัยและเห็นภาพ (เน้นความกระชับ ตัดคำฟุ่มเฟือยออก 10%)",
  "suggestions": [
