...
export const COVENANT_SUMMARY_ITEMS: CovenantSummaryItem[] = [
  ...
  {
    key: 'service',
    title: 'ลักษณะบริการเป็นการสะท้อนใจและแนะแนวส่วนบุคคล',
    description:
      'คำทำนายมีวัตถุประสงค์เพื่อการสะท้อนตนเองและความบันเทิง ไม่ใช่คำแนะนำทางการแพทย์ กฎหมาย หรือการลงทุน',
  },
  {
    key: 'privacy',
